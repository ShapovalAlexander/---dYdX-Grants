...
// tabs
const tabsBtn = document.querySelectorAll(".tabs-rfp__button");
const tabsItem = document.querySelectorAll(".tabs-rfp__content");
...
const fundedBtn = document.querySelectorAll(".fundedgrants__button");
const fundedItem = document.querySelectorAll(".tabs-fundedgrants__content");

fundedBtn.forEach(function(item){
    item.addEventListener("click", function() {
        let currentBtn = item;
        let tabId = currentBtn.getAttribute("data-tab");
        let currentTab = document.querySelector(tabId);
        ...
        if ( ! currentBtn.classList.contains('_active') ){
            ...
            fundedItem.forEach(function(item) {
                item.classList.remove('_active');
            });
...
const expensesBtn = document.querySelectorAll(".expenses__tab_button");
const expensesItem = document.querySelectorAll(".tabs-expenses__content");

expensesBtn.forEach(function(item){
    item.addEventListener("click", function() {
        let currentBtn = item;
        let tabId = currentBtn.getAttribute("data-tab");
        let currentTab = document.querySelector(tabId);
